          ...
          <motion.div variants={itemVariants} className="mb-6">
            <div className="flex space-x-3">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`flex-1 px-4 py-2.5 rounded-xl font-semibold transition duration-300 text-sm ${
                  role === 'jobSeeker'
              ...
              >
                <AnimatePresence mode="wait">
                  {role === 'jobSeeker' && (
                    <motion.span initial={{ scale: 0 }} animate={{ scale: 1 }} exit={{ scale: 0 }} className="mr-2">
                      ✓
                    </motion.span>
                  )}
                </AnimatePresence>
